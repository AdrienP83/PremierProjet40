 ...
 */
final class Version20201105101630 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe DROP FOREIGN KEY FK_Employe_Lieu');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD CONSTRAINT FK_Employe_Lieu FOREIGN KEY (lieu_id) REFERENCES lieu (id)');
